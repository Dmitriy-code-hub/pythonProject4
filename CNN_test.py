...
def run_cnn_ann(data_warehouse, order_stocks):
    ...
    cnn_results.to_csv(join(Base_dir, 'dataSet/testAAPL_afterSplits.csv'), index=False)
...
# X_train, X_test, y_train, y_test = train_test_split(df.drop(axis=0, columns=["Log"]), df["Log"], test_size=0.33, random_state=42)
# print(X_train)
# print(X_test)
# print(y_train)
# print(y_test)
